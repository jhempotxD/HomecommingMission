...
Scoreboard.prototype.show = function(score){
    ...
    gameoverText = this.game.add.bitmapText(0,100, 'minecraftia', 'You are one of few things worth remembering!', 36);
    ...
    startText = this.game.add.bitmapText(0, 300, 'minecraftia', 'Tap to start your adventure again! ', 16);
